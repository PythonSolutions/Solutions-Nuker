...
def Solution_Nuke(token, Server_Name, message_Content):
    setTitle("Nuking...")
    print(f"{Fore.RESET}[{Fore.RED}*{Fore.RESET}] {Fore.BLUE}Solutions Nuke Deployed. . .")
    ...
    setTitle(f"Solutions Nuke Successfully Detonated!")
